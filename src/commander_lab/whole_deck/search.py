...
class WholeDeckSearchEngine(
    ...
    def _hard_gate(self, mainboard: tuple[str, ...]) -> WholeDeckHardGate:
        return hard_gate(self, mainboard)
    ...
    def __init__(
        ...
        *,
        ...
        meta_references: Mapping[FormatBand, MetaFunctionalProfile] | None = None,
    ) -> None:
        ...
        if (
            not self.meta_references
            and context.root is not None
            and policy.functional_meta_weight > 0.0
        ):
