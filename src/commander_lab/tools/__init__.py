...
from .service import ApprovalRequired, CommanderToolService as _BaseCommanderToolService, ToolExecutionError
from .post117_service import Post117CommanderToolService

CommanderToolService = Post117CommanderToolService
