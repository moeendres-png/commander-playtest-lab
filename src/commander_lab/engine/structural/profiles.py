...
ROLE_GROUPS: dict[CardRole, set[str]] = {
    CardRole.RAMP: {
        "Arcane Signet", "Azorius Signet", "Boros Signet", "Cinder Glade",
        "Chandra, Torch of Defiance", "Crop Rotation", "Dark Ritual", "Farseek",
        "Fellwar Stone", "Harrow", "Ignoble Hierarch", "Izzet Signet",
        "Llanowar Elves", "Nature's Lore", "Oracle of Mul Daya", "Orcish Lumberjack",
        "Relic of Legends", "Sakura-Tribe Elder", "Sol Ring", "Soul of Windgrace",
        "Springbloom Druid", "Springleaf Drum", "Sprouting Goblin", "Storm-Kiln Artist",
        "Talisman of Progress", "Tinder Wall", "Tireless Provisioner",
        "Exploration Broodship", "Horizon Explorer", "Evendo Brushrazer",
    },
    CardRole.DRAW: {
        "Braids, Arisen Nightmare", "Chandra, Torch of Defiance", "Combat Research",
        "Consider", "Curiosity", "Deadly Dispute", "Faerie Mastermind",
        "God-Eternal Bontu", "Korvold, Fae-Cursed King", "Loyal Drake",
        "Staggering Insight", "The Gitrog Monster", "Tireless Tracker",
        "Whirlwind of Thought", "Hearthhull, the Worldseed", "Evendo Brushrazer",
    },
    CardRole.SELECTION: {
        "Consider", "Crop Rotation", "Open the Armory", "Preordain", "Narset, Parter of Veils",
    },
    CardRole.REMOVAL: {
        "Ancient Grudge", "Assassin's Trophy", "Beast Within", "Celestial Purge",
        "Chaos Warp", "Fire Covenant", "Imprisoned in the Moon", "Into the Roil",
        "Light of Hope", "Loran of the Third Path", "Path to Exile", "Pest Infestation",
        "Rakdos Charm", "Reality Shift", "Snapback", "Stroke of Midnight",
        "Swords to Plowshares", "Tear Asunder", "Vandalblast", "Wash Away",
        "Wear // Tear", "Windgrace's Judgment", "Nature's Claim",
    },
    CardRole.COUNTER: {
        "An Offer You Can't Refuse", "Counterspell", "Dovin's Veto", "Lofty Denial",
        "Louisoix's Sacrifice", "Negate", "Silence", "Wash Away",
    },
    CardRole.PROTECTION: {
        "Bastion Protector", "Blacksmith's Skill", "Boros Charm", "Esior, Wardwing Familiar",
        "Loran's Escape", "Silence", "Slip Out the Back", "Snakeskin Veil",
        "Swiftfoot Boots", "Tyvar's Stand", "Veil of Summer",
    },
    CardRole.WIPE: {
        "Blasphemous Act", "Chain Reaction", "Culling Ritual", "Farewell",
        "Fire Covenant", "Massacre Wurm", "Pest Infestation", "Toxic Deluge",
        "Vandalblast", "Winds of Rath",
    },
    CardRole.RECURSION: {
        "Aftermath Analyst", "Exploration Broodship", "Ramunap Excavator",
        "Soul of Windgrace", "Splendid Reclamation", "Szarel, Genesis Shepherd",
        "Titania, Protector of Argoth",
    },
    CardRole.GRAVEYARD_HATE: {
        "Bojuka Bog", "Farewell", "Immersturm Predator", "Rakdos Charm", "Soul-Guide Lantern",
    },
    CardRole.ENGINE: {
        "Academy Manufactor", "Braids, Arisen Nightmare", "Chandra, Torch of Defiance",
        "Faerie Mastermind", "God-Eternal Bontu", "Korvold, Fae-Cursed King",
        "Kykar, Wind's Fury", "Mazirek, Kraul Death Priest", "Mirkwood Bats",
        "Narset, Parter of Veils", "Ophiomancer", "Oracle of Mul Daya",
        "Pitiless Plunderer", "Soul of Windgrace", "Storm-Kiln Artist",
        "Szarel, Genesis Shepherd", "The Gitrog Monster", "Tireless Provisioner",
        "Tireless Tracker", "Whirlwind of Thought", "Hearthhull, the Worldseed",
        "Evendo Brushrazer", "Exploration Broodship", "Scouring Swarm",
    },
    CardRole.ENABLER: {
        "Academy Manufactor", "Deadly Dispute", "Exploration Broodship", "Harrow",
        "Horizon Explorer", "Ophiomancer", "Pitiless Plunderer", "Sakura-Tribe Elder",
        "Springbloom Druid", "Tireless Provisioner", "Zuran Orb", "Rograkh, Son of Rohgahh",
        "Springleaf Drum", "Kykar, Wind's Fury", "Storm-Kiln Artist", "Evendo Brushrazer",
    },
    CardRole.PAYOFF: {
        "Academy Manufactor", "Goblin Bombardment", "Guttersnipe", "Hearthhull, the Worldseed",
        "Korvold, Fae-Cursed King", "Mayhem Devil", "Mazirek, Kraul Death Priest",
        "Mirkwood Bats", "Scouring Swarm", "Szarel, Genesis Shepherd",
        "The Gitrog Monster", "Titania, Protector of Argoth", "Whirlwind of Thought",
    },
    CardRole.FINISHER: {
        "Exsanguinate", "Guttersnipe", "Hearthhull, the Worldseed", "Jeska, Thrice Reborn",
        "Kediss, Emberclaw Familiar", "Massacre Wurm", "Mirkwood Bats",
        "Mazirek, Kraul Death Priest", "Szarel, Genesis Shepherd",
    },
    CardRole.COMBAT_PAYOFF: {
        "Blackblade Reforged", "Boros Charm", "Combat Research", "Curiosity",
        "Duelist's Heritage", "Ishai, Ojutai Dragonspeaker", "Jeska, Thrice Reborn",
        "Kediss, Emberclaw Familiar", "Psychotic Fury", "Staggering Insight",
        "Sunhome, Fortress of the Legion", "Swiftfoot Boots",
    },
    CardRole.TOKEN_SOURCE: {
        "Eumidian Hatchery", "Horizon Explorer", "Kykar, Wind's Fury", "Ophiomancer",
        "Pest Infestation", "Scouring Swarm", "Storm-Kiln Artist", "Titania, Protector of Argoth",
        "Tireless Provisioner", "Tireless Tracker",
    },
    CardRole.SACRIFICE_OUTLET: {
        "Braids, Arisen Nightmare", "Deadly Dispute", "Goblin Bombardment",
        "God-Eternal Bontu", "Harrow", "Korvold, Fae-Cursed King", "Zuran Orb",
        "Evendo Brushrazer", "Hearthhull, the Worldseed",
    },
    CardRole.LAND_SYNERGY: {
        "Aftermath Analyst", "Crop Rotation", "Eumidian Hatchery", "Exploration Broodship",
        "Harrow", "Hearthhull, the Worldseed", "Horizon Explorer", "Oracle of Mul Daya",
        "Ramunap Excavator", "Scouring Swarm", "Soul of Windgrace", "Splendid Reclamation",
        "Springbloom Druid", "Sprouting Goblin", "Szarel, Genesis Shepherd",
        "The Gitrog Monster", "Titania, Protector of Argoth", "Tireless Provisioner",
        "Tireless Tracker", "Zuran Orb",
    },
}


MANA_VALUES: dict[str, float] = {
    "Korvold, Fae-Cursed King": 5, "Ishai, Ojutai Dragonspeaker": 4,
    "Rograkh, Son of Rohgahh": 0, "Sol Ring": 1, "Arcane Signet": 2,
    "Swiftfoot Boots": 2, "Zuran Orb": 0, "Exploration Broodship": 1,
    "Exsanguinate": 4, "Massacre Wurm": 6, "Mazirek, Kraul Death Priest": 5,
    "Ophiomancer": 3, "Braids, Arisen Nightmare": 3, "Toxic Deluge": 3,
    "Dark Ritual": 1, "Deadly Dispute": 2, "God-Eternal Bontu": 5,
    "Mirkwood Bats": 4, "Pitiless Plunderer": 4, "Blasphemous Act": 9,
    "Chaos Warp": 3, "Evendo Brushrazer": 3, "Goblin Bombardment": 2,
    "Snakeskin Veil": 1, "Springbloom Druid": 3, "Llanowar Elves": 1,
    "Veil of Summer": 1, "Nature's Claim": 1, "Aftermath Analyst": 2,
    "Beast Within": 3, "Crop Rotation": 1, "Farseek": 2, "Harrow": 3,
    "Nature's Lore": 2, "Oracle of Mul Daya": 4, "Pest Infestation": 3,
    "Ramunap Excavator": 3, "Sakura-Tribe Elder": 2, "Splendid Reclamation": 4,
    "Tireless Provisioner": 3, "Tireless Tracker": 3, "Titania, Protector of Argoth": 5,
    "Tyvar's Stand": 2, "Academy Manufactor": 3, "Immersturm Predator": 4,
    "Fire Covenant": 3, "Mayhem Devil": 3, "Rakdos Charm": 2,
    "Horizon Explorer": 3, "Assassin's Trophy": 2, "Culling Ritual": 4,
    "Szarel, Genesis Shepherd": 5, "Scouring Swarm": 3, "Tear Asunder": 2,
    "The Gitrog Monster": 5, "Windgrace's Judgment": 5, "Ancient Grudge": 2,
    "Orcish Lumberjack": 1, "Sprouting Goblin": 2, "Tinder Wall": 1,
    "Hearthhull, the Worldseed": 4, "Ignoble Hierarch": 1, "Soul of Windgrace": 4,
    "Soul-Guide Lantern": 1, "Chandra, Torch of Defiance": 4,
    "Blackblade Reforged": 2, "Fellwar Stone": 2, "Relic of Legends": 3,
    "Springleaf Drum": 1, "Talisman of Progress": 2, "Stroke of Midnight": 3,
    "Silence": 1, "Light of Hope": 1, "Celestial Purge": 2, "Bastion Protector": 3,
    "Blacksmith's Skill": 1, "Loran of the Third Path": 3, "Loran's Escape": 1,
    "Open the Armory": 2, "Path to Exile": 1, "Swords to Plowshares": 1,
    "Winds of Rath": 5, "Faerie Mastermind": 2, "Into the Roil": 2,
    "Negate": 2, "Imprisoned in the Moon": 3, "Staggering Insight": 2,
    "Curiosity": 1, "An Offer You Can't Refuse": 1, "Farewell": 6,
    "Storm-Kiln Artist": 4, "Clever Impersonator": 4, "Consider": 1,
    "Counterspell": 2, "Combat Research": 1, "Esior, Wardwing Familiar": 2,
    "Lofty Denial": 2, "Louisoix's Sacrifice": 2, "Loyal Drake": 3,
    "Narset, Parter of Veils": 3, "Preordain": 1, "Reality Shift": 2,
    "Slip Out the Back": 1, "Snapback": 2, "Wash Away": 1, "Guttersnipe": 3,
    "Jeska, Thrice Reborn": 3, "Kediss, Emberclaw Familiar": 2,
    "Chain Reaction": 4, "Flare of Duplication": 3, "Psychotic Fury": 2,
    "Boros Charm": 2, "Vandalblast": 1, "Azorius Signet": 2,
    "Dovin's Veto": 2, "Duelist's Heritage": 3, "Izzet Signet": 2,
    "Kykar, Wind's Fury": 4, "Whirlwind of Thought": 4, "Boros Signet": 2,
    "Wear // Tear": 3,
}


BASE_POWER: dict[str, float] = {
    "Korvold, Fae-Cursed King": 4, "Ishai, Ojutai Dragonspeaker": 1,
    "Rograkh, Son of Rohgahh": 0, "Massacre Wurm": 6, "Mazirek, Kraul Death Priest": 2,
    "Ophiomancer": 2, "God-Eternal Bontu": 5, "Mirkwood Bats": 2,
    "Pitiless Plunderer": 1, "Evendo Brushrazer": 2, "Llanowar Elves": 1,
    "Oracle of Mul Daya": 2, "Ramunap Excavator": 2, "Sakura-Tribe Elder": 1,
    "Tireless Provisioner": 3, "Tireless Tracker": 3, "Titania, Protector of Argoth": 5,
    "Academy Manufactor": 1, "Immersturm Predator": 3, "Mayhem Devil": 3,
    "Horizon Explorer": 3, "Szarel, Genesis Shepherd": 2, "Scouring Swarm": 1,
    "The Gitrog Monster": 6, "Orcish Lumberjack": 1, "Sprouting Goblin": 2,
    "Tinder Wall": 0, "Hearthhull, the Worldseed": 6, "Ignoble Hierarch": 0,
    "Soul of Windgrace": 5, "Bastion Protector": 3, "Loran of the Third Path": 2,
    "Faerie Mastermind": 2, "Storm-Kiln Artist": 2, "Clever Impersonator": 3,
    "Esior, Wardwing Familiar": 1, "Loyal Drake": 2, "Guttersnipe": 2,
    "Kediss, Emberclaw Familiar": 1, "Kykar, Wind's Fury": 3,
}


PERMANENT_EXCEPTIONS = {
    "Exsanguinate", "Toxic Deluge", "Dark Ritual", "Deadly Dispute", "Blasphemous Act",
    "Chaos Warp", "Snakeskin Veil", "Veil of Summer", "Nature's Claim", "Beast Within",
    "Crop Rotation", "Farseek", "Harrow", "Nature's Lore", "Pest Infestation",
    "Splendid Reclamation", "Tyvar's Stand", "Fire Covenant", "Rakdos Charm",
    "Assassin's Trophy", "Culling Ritual", "Tear Asunder", "Windgrace's Judgment",
    "Ancient Grudge", "Stroke of Midnight", "Silence", "Light of Hope", "Celestial Purge",
    "Blacksmith's Skill", "Loran's Escape", "Open the Armory", "Path to Exile",
    "Swords to Plowshares", "Winds of Rath", "Into the Roil", "Negate",
    "An Offer You Can't Refuse", "Farewell", "Consider", "Counterspell", "Lofty Denial",
    "Louisoix's Sacrifice", "Preordain", "Reality Shift", "Slip Out the Back", "Snapback",
    "Wash Away", "Chain Reaction", "Flare of Duplication", "Psychotic Fury", "Boros Charm",
    "Vandalblast", "Dovin's Veto", "Wear // Tear",
}
...
HIGH_IMMEDIATE = {
    "Sol Ring", "Dark Ritual", "Deadly Dispute", "Toxic Deluge", "Blasphemous Act",
    "Farewell", "Fire Covenant", "Exsanguinate", "Path to Exile", "Swords to Plowshares",
    "An Offer You Can't Refuse", "Counterspell", "Dovin's Veto", "Boros Charm",
    "Rakdos Charm", "Pest Infestation", "Culling Ritual", "Massacre Wurm",
}
HIGH_TURN_CYCLE_RISK = {
    "Horizon Explorer", "Scouring Swarm", "Mazirek, Kraul Death Priest",
    "Szarel, Genesis Shepherd", "Whirlwind of Thought", "Duelist's Heritage",
    "Blackblade Reforged", "Staggering Insight", "Curiosity", "Combat Research",
}
MULTIPLAYER_SCALING: dict[str, float] = {
    "Korvold, Fae-Cursed King": 0.1, "Mirkwood Bats": 1.2, "Exsanguinate": 1.3,
    "Massacre Wurm": 1.1, "Hearthhull, the Worldseed": 1.2, "Windgrace's Judgment": 0.8,
    "Braids, Arisen Nightmare": 0.6, "Faerie Mastermind": 0.9,
    "Ishai, Ojutai Dragonspeaker": 1.0, "Kediss, Emberclaw Familiar": 1.2,
    "Guttersnipe": 1.1, "Farewell": 0.7, "Blasphemous Act": 0.6,
    "Chain Reaction": 0.6, "Pest Infestation": 0.5, "Culling Ritual": 0.7,
}
...
LAND_PRODUCES: dict[str, frozenset[Color]] = {
    "Plains": frozenset({Color.WHITE}), "Island": frozenset({Color.BLUE}),
    "Swamp": frozenset({Color.BLACK}), "Mountain": frozenset({Color.RED}),
    "Forest": frozenset({Color.GREEN}), "Bojuka Bog": frozenset({Color.BLACK}),
    "Eumidian Hatchery": frozenset({Color.BLACK}), "Canyon Slough": frozenset({Color.BLACK, Color.RED}),
    "Smoldering Marsh": frozenset({Color.BLACK, Color.RED}), "Sulfurous Springs": frozenset({Color.BLACK, Color.RED}),
    "Llanowar Wastes": frozenset({Color.BLACK, Color.GREEN}), "Twilight Mire": frozenset({Color.BLACK, Color.GREEN}),
    "Vernal Fen": frozenset({Color.BLACK, Color.GREEN}), "Cinder Glade": frozenset({Color.RED, Color.GREEN}),
    "Karplusan Forest": frozenset({Color.RED, Color.GREEN}), "Adarkar Wastes": frozenset({Color.WHITE, Color.BLUE}),
    "Glacial Fortress": frozenset({Color.WHITE, Color.BLUE}), "Port Town": frozenset({Color.WHITE, Color.BLUE}),
    "Prairie Stream": frozenset({Color.WHITE, Color.BLUE}), "Shivan Reef": frozenset({Color.BLUE, Color.RED}),
    "Sulfur Falls": frozenset({Color.BLUE, Color.RED}), "Battlefield Forge": frozenset({Color.WHITE, Color.RED}),
    "Clifftop Retreat": frozenset({Color.WHITE, Color.RED}), "Temple of Enlightenment": frozenset({Color.WHITE, Color.BLUE}),
    "Skycloud Expanse": frozenset({Color.WHITE, Color.BLUE}), "Turbulent Springs": frozenset({Color.BLUE, Color.RED}),
    "Sunhome, Fortress of the Legion": frozenset({Color.WHITE, Color.RED}),
}
ALL_COLORS = frozenset(Color)
FLEXIBLE_LANDS = {
    "Command Tower", "Exotic Orchard", "Fabled Passage", "Evolving Wilds", "Terramorphic Expanse",
    "Jund Panorama", "Cabaretti Courtyard", "Escape Tunnel", "Mountain Valley",
    "Riveteers Overlook", "Rocky Tar Pit", "Demolition Field", "Opal Palace",
}
...
def _mana_value(card: CardIdentity, roles: frozenset[CardRole]) -> float:
    ...
    if CardRole.WIPE in roles or CardRole.FINISHER in roles:
        return 5.0
    if roles.intersection({CardRole.COUNTER, CardRole.PROTECTION, CardRole.REMOVAL, CardRole.SELECTION}):
        return 2.0
...
def build_default_profile(card: CardIdentity) -> StructuralCardProfile:
    ...
    if card.oracle_name in FLEXIBLE_LANDS:
        produced = ALL_COLORS
    if card.oracle_name in {"Arcane Signet", "Fellwar Stone", "Relic of Legends", "Springleaf Drum"}:
        produced = ALL_COLORS
    ...
    if card.oracle_name in ROLE_GROUPS[CardRole.LAND_SYNERGY] or card.oracle_name in ROLE_GROUPS[CardRole.SACRIFICE_OUTLET]:
        commander_synergy = 0.7
    if card.oracle_name in {"Combat Research", "Curiosity", "Staggering Insight", "Kediss, Emberclaw Familiar", "Jeska, Thrice Reborn", "Duelist's Heritage", "Blackblade Reforged"}:
        commander_synergy = 0.9
    immediate = 1.1 if card.oracle_name in HIGH_IMMEDIATE else (0.8 if not card.oracle_name in HIGH_TURN_CYCLE_RISK else 0.35)
    turn_risk = 0.8 if card.oracle_name in HIGH_TURN_CYCLE_RISK else (0.15 if card.oracle_name in HIGH_IMMEDIATE else 0.45)
    floor = 0.45
    if roles.intersection({CardRole.REMOVAL, CardRole.COUNTER, CardRole.PROTECTION, CardRole.RAMP, CardRole.DRAW}):
        floor = 0.85
    ...
    if CardRole.SACRIFICE_OUTLET in roles or CardRole.PAYOFF in roles:
        conditionals.append(ConditionalStrength(condition="sacrifice_package_online", multiplier=1.35))
    ...
    if source_url is not None:
        sources = (SourceRef(source_type="card_database", source_name="mtg.wtf", source_path=source_url, quality=DataQuality.PROJECT_VERIFIED),)
    if card.oracle_name in {"Exploration Broodship", "Hearthhull, the Worldseed", "Szarel, Genesis Shepherd", "Eumidian Hatchery", "Evendo Brushrazer", "Scouring Swarm"}:
...
class StructuralProfileCatalog:
    ...
    def profiles(self) -> tuple[StructuralCardProfile, ...]:
        return tuple(sorted(self._profiles.values(), key=lambda profile: profile.oracle_name.casefold()))
...
def build_structural_deck_profile(
    ...
    *,
    ...
    return StructuralDeckProfile(
        ...
        commander_base_costs={name: base_costs.get(name, 4.0) for name in deck.commander.commanders},
        commander_base_power={name: base_power.get(name, 2.0) for name in deck.commander.commanders},
