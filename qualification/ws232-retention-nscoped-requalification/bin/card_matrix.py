...
CARDS = {
    "CARD_01": {"name": "Ishai, Ojutai Dragonspeaker", "kind": "BATTLEFIELD",
                ...
                "notes": "commander is the focus (legend pair in 99); counter growth on opponent casts",
    ...
    "CARD_02": {"name": "Rograkh, Son of Rohgahh", "kind": "BATTLEFIELD",
                ...
                "notes": "commander is the focus (legend pair); legend-rule SBA on second copy",
                "lands": {"Mountain": 98}},
    "CARD_03": {"name": "Esior, Wardwing Familiar", "kind": "BATTLEFIELD",
                "commander": "Esior, Wardwing Familiar", "commander_power": 1,
                "notes": "commander is the focus (legend pair); evasive pings vs 1-power baseline",
                "lands": {"Island": 98}},
    ...
    "CARD_05": {"name": "Veyran, Voice of Duality", "kind": "BATTLEFIELD",
                ...
                "notes": "commander is the focus (legend pair)",
    ...
    "CARD_10": {"name": "Wash Away", "kind": "CHAIN",
                ...
                "lands": {"Island": 98}},
    "CARD_11": {"name": "Wear // Tear", "kind": "GRAVEYARD_CAST",
    ...
    "CARD_12": {"name": "Dig Through Time", "kind": "GRAVEYARD_CAST",
                ...
                "lands": {"Island": 98}},
    "CARD_13": {"name": "Flare of Duplication", "kind": "CHAIN",
                "commander": "Rograkh, Son of Rohgahh", "commander_power": 0,
                "notes": "copy chain: opponent spell on stack + Flare consumed",
                "lands": {"Mountain": 98}},
    "CARD_14": {"name": "Vandalblast", "kind": "GRAVEYARD_CAST",
                "commander": "Rograkh, Son of Rohgahh", "commander_power": 0,
    ...
    "CARD_16": {"name": "Psychosis Crawler", "kind": "BATTLEFIELD",
                ...
                "lands": {"Mountain": 98}},
    "CARD_17": {"name": "Kaervek the Merciless", "kind": "CHAIN",
                "commander": "Kaervek the Merciless", "commander_power": 5,
                "notes": "commander is the focus; arrival + opponent-cast damage chain; 5-power baseline",
                "lands": {"Swamp": 49, "Mountain": 49}},
    "CARD_18": {"name": "Shriekmaw", "kind": "CHAIN",
                "commander": "Toshiro Umezawa", "commander_power": 2,
                "notes": "evoke destroy chain: enemy creature departs to command + choice decisions",
                "lands": {"Swamp": 98}},
    "CARD_19": {"name": "Butcher of Malakir", "kind": "CHAIN",
                "commander": "Toshiro Umezawa", "commander_power": 2,
    ...
    "CARD_21": {"name": "Gratuitous Violence", "kind": "BATTLEFIELD",
                ...
                "lands": {"Mountain": 98}},
    "CARD_22": {"name": "Bolt Bend", "kind": "GRAVEYARD_CAST",
                "commander": "Rograkh, Son of Rohgahh", "commander_power": 0,
    ...
    "CARD_23": {"name": "Makeshift Mannequin", "kind": "GRAVEYARD_CAST",
                ...
                "lands": {"Swamp": 98}},
    "CARD_24": {"name": "Warstorm Surge", "kind": "CHAIN",
                "commander": "Rograkh, Son of Rohgahh", "commander_power": 0,
                "notes": "arrival + later own-creature ETB trigger decisions",
                "lands": {"Mountain": 98}},
    "CARD_25": {"name": "Basilisk Collar", "kind": "CHAIN",
    ...
    "CARD_27": {"name": "Path of Ancestry", "kind": "BATTLEFIELD",
                ...
                "lands": {"Mountain": 98}},
    "CARD_28": {"name": "Find // Finality", "kind": "CHAIN",
    ...
    "CARD_29": {"name": "Boseiju Reaches Skyward // Branch of Boseiju",
                "kind": "BATTLEFIELD",
