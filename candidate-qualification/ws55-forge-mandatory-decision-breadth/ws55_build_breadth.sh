#!/bin/bash
# WS55 mandatory decision-breadth provider build (WS55-owned, qualification-only).
...
#   overlay -> javac against pinned prebuilt classes.
# Forge checkout consumed READ-ONLY. No WS48/WS53/shared file is modified.
set -euo pipefail
export JAVA_HOME=/usr/lib/jvm/java-17-openjdk-amd64
WS=/home/moeen/code/ws55-forge-mandatory-decision-breadth
...
sha256sum "$out/java/forge/game/player/Ws23ForgeVerticalProvider.java" "$out/java/forge/game/player/Ws40SuccessorState.java" > "$EV/WS55_PROVIDER_DIGESTS.txt"
cat "$EV/WS55_PROVIDER_DIGESTS.txt"
echo WS55-BREADTH-BUILD-OK
