...
def patch_session() -> None:
    ...
    # WS39 inserts its Commander probe after the inherited WS34 proof call. Do
    # not anchor on the surrounding return block: replace exactly the single
    # invocation so the independently useful WS39 probe remains untouched.
    text = replace_once(
        text,
