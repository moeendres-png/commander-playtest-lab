...
This is construction admission only. It grants no behavior/runtime PASS and
imports no historical successor PASS.
"""
...
def main() -> int:
    ...
    output = {
        "schema_version": "commander-lab.ws42-full107-construction-probe/1.0.0",
