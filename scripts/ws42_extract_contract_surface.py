...
provider work can consume the immutable 1.3 MiB materialization through a
small auditable artifact while CI remains pinned to the WS-41 source lock.
"""
...
KEEP_TOP = (
    ...
    "native_procedure", "decision_script", "setup_validation", "expected_outcome", "postconditions",
    "architecture_freeze_gate", "authority_refs",
)
...
def main() -> int:
    ...
    out={
      'artifact_version':'commander-lab.ws42-contract-surface/1.0.0',
