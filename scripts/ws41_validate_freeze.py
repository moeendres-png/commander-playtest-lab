...
"WS41_SHA256SUMS","WS41_FINAL_HANDOFF.md"}
...
def main()->int:
 ...
 if report.get("terminal_status")!="PASS" or report.get("semantic_executable_count")!=135 or report.get("contract_defect_count")!=0:raise SystemExit("135 semantic executability failure")
 ...
 print(json.dumps({"status":"PASS","required_outputs":len(REQUIRED),"checksum_rows":len(checks),"records":135,"provider_denominator":107,"pilot_choice_requested_state_digest":PILOT_NEW},sort_keys=True))
 return 0
